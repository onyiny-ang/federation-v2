...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "FederatedReplicaSetStatus Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	Eventually(func() interface{} {
		return arguments.ControllerManager.GetController("FederatedReplicaSetStatusController")
	}).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("FederatedReplicaSetStatusController")
})
