...
var SchemeGroupVersion = schema.GroupVersion{Group: "status.federation.k8s.io", Version: "v1alpha1"}
...
type FederatedReplicaSetStatusList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []FederatedReplicaSetStatus `json:"items"`
}
...
var (
	...
	FederatedReplicaSetStatusCRD = v1beta1.CustomResourceDefinition{
		ObjectMeta: metav1.ObjectMeta{
			Name: "federatedreplicasetstatuses.status.federation.k8s.io",
		},
		Spec: v1beta1.CustomResourceDefinitionSpec{
			Group:   "status.federation.k8s.io",
			Version: "v1alpha1",
			Names: v1beta1.CustomResourceDefinitionNames{
				Kind:   "FederatedReplicaSetStatus",
