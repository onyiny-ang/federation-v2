...
minikube start --vm-driver kvm -p ${CONTEXT} --kubernetes-version v1.11.0
minikube start --vm-driver kvm -p ${CONTEXT2} --kubernetes-version v1.11.0
minikube start --vm-driver kvm -p ${CONTEXT3} --kubernetes-version v1.11.0
